;(function(root, factory) {
    ...
    function setCookie(name, value, expirationInSeconds, path, domain) {
        ...
        if (domain) {
            cookieValue += '; domain=' + punycode.toASCII(domain);
        }
    ...
    /**
     * Helper to generate a random integer between
     * arguments range.
     *
     * @param {Number} min
     * @param {Number} max
    ...
    return {
        /**
         * Calculates segment, saves it in cookies and returns it.
         *
         * @param {Number} segments Amount of segments
         * @param {Object} options Options
         * @param {String} options.splitName Test name to append to cookie key
         * @param {Number} options.expireInDay=60 Cookie TTL
         * @param {Array|String} options.domain Cookie domain
         * @param {String} options.path Cookie path
         * @returns {NaN|Number} User's segment
         */
        getVisitorSegment: function (segments, options) {
            options = options || {};
            ...
            var domains = Array.isArray(options.domain)? options.domain: [options.domain];
